...
- Case001 は本編としてプレイ可能です。Case001 を追加掲載する場合は、Case000 と同様に実際のプレイ画面と役割が分かる説明を使用します。
...
- `docs/images/case000-result.svg`: 最終判断後の行政処理ログと、事件選択へ戻る導線が見える結果画面。
- `docs/images/case-select.svg`: Case000 と Case001 がともに監査可能だと分かる事件選択画面。
