...
- 右ペインのノード情報は、ノードタイトル、証拠状態バー、`summary`、`simpleFact`、`inspectorNote`、critical の場合のみ `warning`、詳細記録、提出根拠、矛盾分類、追加解析、の順に固定する。
...
- 赤い警告パネルは `critical`、または矛盾を持つ `high` / `critical` 記録に限定する。
