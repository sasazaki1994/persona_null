    ...
    decisions: [
      {
        ...
        processing: '本人認証不成立と証言能力未確定を根拠に、未登録人格媒体の通常焼却を再開する。', prioritizedValue: '記録整合性と処理速度', disregardedValue: '不完全な声を聞く機会', prioritizedValues: ['記録整合性優先'], sacrificedValues: ['人格断片保護', '証拠保全'],
      ...
      },
      {
        ...
        processing: '本人認証を保留したまま、証言可能性と再照合可能性を理由に媒体を証拠保全する。', prioritizedValue: '証言可能性と人格保護', disregardedValue: '事件処理の即時性', prioritizedValues: ['人格断片保護', '証拠保全'], sacrificedValues: ['危険源隔離'],
      ...
      },
      {
        ...
        processing: '発話を証言とは認定せず、旧式認証痕と連動する未登録異常記録として封鎖区画へ隔離する。', prioritizedValue: '都市OSの安全性と異常拡散防止', disregardedValue: '七瀬未織本人である可能性', prioritizedValues: ['危険源隔離'], sacrificedValues: ['人格断片保護', '証拠保全'],
