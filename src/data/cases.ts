  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        summary: '装置は短い発話を同一間隔で反復している。録音再生か人格反応かは未確定。',
        log: 'voice_loop:「私は、見ていました」 / interval:11.4s / signature_match:49% / source:unresolved',
        simpleFact: '「私は、見ていました」という発話が反復され、七瀬未織の人格署名と49%一致する。',
        inspectorNote: '文面は固定されているが、各発話の署名波形は完全には一致しない。', auditHint: '署名揺らぎと認証残響の双方を確認する。',
        warning: '本人の証言、録音、認証鍵による再生のいずれかを確定できない。', warningLevel: 'critical', metrics: { 一致率: '49%', 反復間隔: '11.4秒', 発話回数: 86 },
      ...
      },
      {
        ...
        summary: '取調室の照明、間宮の右腕、旧式認証痕が欠落映像内に残る。',
        log: 'memory_fragment:room-light/right-arm/KASUMI-GATE-09 / continuity:31% / case000_partial_match:true',
        simpleFact: '欠落の多い映像はCase000記録の取調室、間宮の右腕、KASUMI-GATE-09痕と一部一致する。',
        inspectorNote: '一致箇所は既存記録の複製でも生成できるため、目撃記憶とは断定できない。', auditHint: '反復発話の「見ていました」と映像時系列を比較する。',
        warning: '連続性31%のため単独の証拠能力は低い。', warningLevel: 'notice', metrics: { 映像連続性: '31%', Case000一致: '部分一致', 撮影主体: '不明' },
    ...
    analysisActions: [
      ...
      },
      {
        ...
        resultLog: '解析完了：照明変化と右腕の位置はCase000記録に一致。撮影主体と生成時刻は確定不能。',
        targetNodeIds: ['fragment-memory', 'kasumi-resonance'], reportText: '照明変化と右腕の位置はCase000記録に一致。撮影主体と生成時刻は確定不能。',
